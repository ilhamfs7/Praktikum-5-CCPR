...
<head>
    ...
    <title>Portal Pendaftaran Pegawai Baru</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form action="/daftar" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                <label for="ktp" class="block text-sm font-medium text-gray-700">Upload File KTP/CV (Gambar)</label>
                <input type="file" id="ktp" name="ktp" accept="image/jpeg, image/png, image/jpg" required 
                    class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                <p class="mt-1 text-xs text-gray-500">Maksimal ukuran file 5MB. Format: JPG, JPEG, PNG.</p>
            </div>
